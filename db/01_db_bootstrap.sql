...
-- Cancer Type table
insert into cancer_type (cancer_type_id, name, description) values (1, 'Toxic effect of venom of scorpion, accidental, ini', 'Insertion of Facet Replacement Spinal Stabilization Device into Occipital-cervical Joint, Percutaneous Approach');
...
insert into cancer_type (cancer_type_id, name, description) values (3, 'Capslr glaucoma w/pseudxf lens, unsp eye, indeterm', 'Dressing of Face using Bandage');
...
insert into cancer_type (cancer_type_id, name, description) values (7, 'Occ of anml-drn vehicle injured in clsn w ped/anml', 'Insertion of Intraluminal Device into Large Intestine, Percutaneous Approach');
insert into cancer_type (cancer_type_id, name, description) values (8, 'Assault by drowning and submersion while in bathtu', 'Magnetic Resonance Imaging (MRI) of Bilateral Kidneys using Other Contrast');
insert into cancer_type (cancer_type_id, name, description) values (9, 'Stable burst fracture of fourth thoracic vertebra', 'High Dose Rate (HDR) Brachytherapy of Duodenum using Californium 252 (Cf-252)');
insert into cancer_type (cancer_type_id, name, description) values (10, 'Injury of median nerve at forearm level, left arm', 'Restriction of Cervix, Percutaneous Endoscopic Approach');
...
insert into cancer_type (cancer_type_id, name, description) values (12, 'Partial traumatic MCP amputation of left thumb', 'Supplement Right Axillary Vein with Autologous Tissue Substitute, Open Approach');
...
insert into cancer_type (cancer_type_id, name, description) values (14, 'Unsp fx shaft of unsp tibia, subs for clos fx', 'Supplement Scrotum with Nonautologous Tissue Substitute, Percutaneous Endoscopic Approach');
insert into cancer_type (cancer_type_id, name, description) values (15, 'Contact with workbench tool, subsequent', 'Revision of Nonautologous Tissue Substitute in Tracheobronchial Tree, Open Approach');

-- Users table
insert into user (user_id, first_name, last_name, occupation, birth_date, gender, city, state, cancer_type_id, email_1, email_2, phone_1, phone_2) values (1, 'Babbie', 'Bettles', 'Administrative Assistant III', '1975/10/07', 'Non-binary', 'Bloomington', 'Illinois', 12, 'bbettles0@t.co', 'bbettles0@techcrunch.com', '309-203-5885', '785-967-9662');
insert into user (user_id, first_name, last_name, occupation, birth_date, gender, city, state, cancer_type_id, email_1, email_2, phone_1, phone_2) values (2, 'Daryl', 'Conen', 'Statistician I', '2007/01/03', 'Female', 'Young America', 'Minnesota', 1, 'dconen1@huffingtonpost.com', 'dconen1@yellowpages.com', '952-697-7775', '312-665-0800');
insert into user (user_id, first_name, last_name, occupation, birth_date, gender, city, state, cancer_type_id, email_1, email_2, phone_1, phone_2) values (3, 'Iolanthe', 'Kull', 'Developer II', '2022/08/18', 'Female', 'Naples', 'Florida', 2, 'ikull2@merriam-webster.com', 'ikull2@soundcloud.com', '305-233-2032', '503-505-3712');
insert into user (user_id, first_name, last_name, occupation, birth_date, gender, city, state, cancer_type_id, email_1, email_2, phone_1, phone_2) values (4, 'Bentlee', 'Pyecroft', 'Developer III', '2021/08/19', 'Bigender', 'Memphis', 'Tennessee', 6, 'bpyecroft3@mashable.com', 'bpyecroft3@instagram.com', '615-771-9855', '585-920-1622');
insert into user (user_id, first_name, last_name, occupation, birth_date, gender, city, state, cancer_type_id, email_1, email_2, phone_1, phone_2) values (5, 'Gaspar', 'Bowmer', 'Tax Accountant', '1997/03/05', 'Genderqueer', 'Spokane', 'Washington', 5, 'gbowmer4@umich.edu', 'gbowmer4@reddit.com', '509-685-1319', '816-418-6791');
insert into user (user_id, first_name, last_name, occupation, birth_date, gender, city, state, cancer_type_id, email_1, email_2, phone_1, phone_2) values (6, 'Gideon', 'Duplain', 'Staff Accountant IV', '1954/09/08', 'Male', 'Grand Forks', 'North Dakota', 10, 'gduplain5@amazon.de', 'gduplain5@tumblr.com', '701-921-0359', '915-933-7533');
insert into user (user_id, first_name, last_name, occupation, birth_date, gender, city, state, cancer_type_id, email_1, email_2, phone_1, phone_2) values (7, 'Ezekiel', 'McPhilip', 'Assistant Manager', '1975/08/09', 'Male', 'Raleigh', 'North Carolina', 14, 'emcphilip6@nasa.gov', 'emcphilip6@aol.com', '919-545-4875', '801-436-2614');
insert into user (user_id, first_name, last_name, occupation, birth_date, gender, city, state, cancer_type_id, email_1, email_2, phone_1, phone_2) values (8, 'Ingmar', 'Charer', 'Assistant Media Planner', '1990/09/21', 'Male', 'Flint', 'Michigan', 3, 'icharer7@cpanel.net', 'icharer7@hhs.gov', '810-361-7231', '956-763-3371');
insert into user (user_id, first_name, last_name, occupation, birth_date, gender, city, state, cancer_type_id, email_1, email_2, phone_1, phone_2) values (9, 'Kalina', 'Byer', 'Professor', '1959/05/30', 'Female', 'Fresno', 'California', 8, 'kbyer8@vinaora.com', 'kbyer8@addthis.com', '559-610-2434', '510-234-6064');
insert into user (user_id, first_name, last_name, occupation, birth_date, gender, city, state, cancer_type_id, email_1, email_2, phone_1, phone_2) values (10, 'Lowell', 'Golby', 'Senior Sales Associate', '1987/07/11', 'Male', 'Alexandria', 'Virginia', 15, 'lgolby9@narod.ru', 'lgolby9@mashable.com', '571-560-1589', '408-119-1435');
insert into user (user_id, first_name, last_name, occupation, birth_date, gender, city, state, cancer_type_id, email_1, email_2, phone_1, phone_2) values (11, 'Graeme', 'Whiting', 'Quality Control Specialist', '1985/04/18', 'Male', 'Charlotte', 'North Carolina', 13, 'gwhitinga@mysql.com', 'gwhitinga@nifty.com', '704-894-4482', '808-312-8488');
insert into user (user_id, first_name, last_name, occupation, birth_date, gender, city, state, cancer_type_id, email_1, email_2, phone_1, phone_2) values (12, 'Loree', 'Barttrum', 'Director of Sales', '1975/03/26', 'Female', 'Conroe', 'Texas', 11, 'lbarttrumb@craigslist.org', 'lbarttrumb@gov.uk', '936-482-6124', '803-320-1701');
insert into user (user_id, first_name, last_name, occupation, birth_date, gender, city, state, cancer_type_id, email_1, email_2, phone_1, phone_2) values (13, 'Elissa', 'Habishaw', 'Dental Hygienist', '2001/09/01', 'Genderqueer', 'Phoenix', 'Arizona', 9, 'ehabishawc@jiathis.com', 'ehabishawc@unicef.org', '480-779-4777', '915-788-2628');
insert into user (user_id, first_name, last_name, occupation, birth_date, gender, city, state, cancer_type_id, email_1, email_2, phone_1, phone_2) values (14, 'Kliment', 'Garrattley', 'Staff Accountant II', '1979/07/17', 'Male', 'Jacksonville', 'Florida', 7, 'kgarrattleyd@quantcast.com', 'kgarrattleyd@cornell.edu', '904-927-9779', '702-716-5101');
insert into user (user_id, first_name, last_name, occupation, birth_date, gender, city, state, cancer_type_id, email_1, email_2, phone_1, phone_2) values (15, 'Mei', 'Shakesby', 'Graphic Designer', '1989/01/19', 'Female', 'New York City', 'New York', 4, 'mshakesbye@netlog.com', 'mshakesbye@nydailynews.com', '917-620-8264', '202-283-8104');
insert into user (user_id, first_name, last_name, occupation, birth_date, gender, city, state, cancer_type_id, email_1, email_2, phone_1, phone_2) values (16, 'Suzy', 'Gamlen', 'Legal Assistant', '2014/05/21', 'Female', 'Dallas', 'Texas', 2, 'sgamlenf@opensource.org', 'sgamlenf@sourceforge.net', '972-340-8641', '202-260-8751');
insert into user (user_id, first_name, last_name, occupation, birth_date, gender, city, state, cancer_type_id, email_1, email_2, phone_1, phone_2) values (17, 'Anabella', 'Loughnan', 'Clinical Specialist', '1988/03/18', 'Female', 'New York City', 'New York', 3, 'aloughnang@comcast.net', 'aloughnang@home.pl', '212-982-0719', '912-941-6675');
insert into user (user_id, first_name, last_name, occupation, birth_date, gender, city, state, cancer_type_id, email_1, email_2, phone_1, phone_2) values (18, 'Cristal', 'Van Merwe', 'Research Assistant IV', '1968/08/09', 'Female', 'Indianapolis', 'Indiana', 7, 'cvanmerweh@arstechnica.com', 'cvanmerweh@vk.com', '317-932-8130', '360-773-9130');
insert into user (user_id, first_name, last_name, occupation, birth_date, gender, city, state, cancer_type_id, email_1, email_2, phone_1, phone_2) values (19, 'Agace', 'Pinckard', 'Internal Auditor', '1971/07/10', 'Female', 'Boston', 'Massachusetts', 14, 'apinckardi@dagondesign.com', 'apinckardi@imageshack.us', '508-182-0182', '716-816-5817');
insert into user (user_id, first_name, last_name, occupation, birth_date, gender, city, state, cancer_type_id, email_1, email_2, phone_1, phone_2) values (20, 'Louisette', 'Longley', 'Engineer I', '1993/08/14', 'Female', 'Birmingham', 'Alabama', 9, 'llongleyj@360.cn', 'llongleyj@guardian.co.uk', '205-994-8093', '615-404-4179');
...
-- Exhibits table
insert into exhibits (user_id, symptom_id, start_date, end_date, severity) values (13, 9, '2014/07/01', '1982/02/14', 'Mal neo paraurethral');
insert into exhibits (user_id, symptom_id, start_date, end_date, severity) values (1, 8, '1952/12/25', '1990/06/19', 'Cl skl w oth fx w/o coma');
insert into exhibits (user_id, symptom_id, start_date, end_date, severity) values (9, 3, '1958/04/05', '2011/06/11', 'Ac infect polyneuritis');
insert into exhibits (user_id, symptom_id, start_date, end_date, severity) values (6, 7, '1964/11/18', '1974/03/20', 'Hered hemolytic anem NEC');
insert into exhibits (user_id, symptom_id, start_date, end_date, severity) values (12, 13, '1963/04/30', '1982/03/07', 'Gonococcal peritonitis');
insert into exhibits (user_id, symptom_id, start_date, end_date, severity) values (15, 1, '1949/08/04', '1982/02/07', 'Acq deformity NEC');
insert into exhibits (user_id, symptom_id, start_date, end_date, severity) values (16, 20, '1960/05/24', '1965/07/11', 'Gastrojejun ulc NOS-obst');
insert into exhibits (user_id, symptom_id, start_date, end_date, severity) values (11, 15, '1986/07/09', '1953/01/13', 'Stomach cont asp w resp');
insert into exhibits (user_id, symptom_id, start_date, end_date, severity) values (4, 18, '1994/01/04', '1957/05/14', 'War inj:therml radiation');
insert into exhibits (user_id, symptom_id, start_date, end_date, severity) values (5, 10, '1962/09/11', '1962/11/20', 'Adv eff anti-common cold');
insert into exhibits (user_id, symptom_id, start_date, end_date, severity) values (2, 11, '1985/11/04', '1980/03/30', 'Cl skul fx NEC-deep coma');
insert into exhibits (user_id, symptom_id, start_date, end_date, severity) values (14, 17, '2021/02/22', '1970/07/30', 'Obesity-postpartum');
insert into exhibits (user_id, symptom_id, start_date, end_date, severity) values (7, 5, '1994/03/20', '1950/02/03', 'Histoplasm caps endocard');
insert into exhibits (user_id, symptom_id, start_date, end_date, severity) values (18, 2, '2022/06/08', '1980/09/30', 'Disturbances of vision');
insert into exhibits (user_id, symptom_id, start_date, end_date, severity) values (8, 4, '1975/01/03', '1971/03/07', 'Malig neo retromolar');
insert into exhibits (user_id, symptom_id, start_date, end_date, severity) values (17, 12, '1957/05/29', '1977/03/13', 'General medical exam NOS');
insert into exhibits (user_id, symptom_id, start_date, end_date, severity) values (20, 16, '2019/10/17', '2019/12/29', 'Excitativ type psychosis');
insert into exhibits (user_id, symptom_id, start_date, end_date, severity) values (19, 6, '2005/10/24', '2001/03/18', 'History-pre-term labor');
insert into exhibits (user_id, symptom_id, start_date, end_date, severity) values (10, 19, '1987/02/28', '2021/11/06', 'Dust pneumonopathy NEC');
insert into exhibits (user_id, symptom_id, start_date, end_date, severity) values (3, 14, '1992/11/24', '1955/08/29', 'Ac laryngitis w obstruct');
...
insert into treatment_center (center_id, street_address, state, city, zip_code, professional_id, email_1, email_2, phone_1, phone_2) values (2, '44 Texas Court', 'MA', 'Newton', '8', 3, 'ikeynes1@craigslist.org', 'fhaskell1@taobao.com', '508-112-3218', '805-160-9624');
insert into treatment_center (center_id, street_address, state, city, zip_code, professional_id, email_1, email_2, phone_1, phone_2) values (3, '51 Dovetail Trail', 'KY', 'Louisville', '7', 7, 'alancley2@nifty.com', 'mburgan2@livejournal.com', '502-584-5922', '202-164-1134');
insert into treatment_center (center_id, street_address, state, city, zip_code, professional_id, email_1, email_2, phone_1, phone_2) values (4, '075 Sundown Pass', 'CA', 'San Jose', '7819', 4, 'xhamber3@tiny.cc', 'prougier3@google.ca', '408-143-3468', '804-298-2811');
insert into treatment_center (center_id, street_address, state, city, zip_code, professional_id, email_1, email_2, phone_1, phone_2) values (5, '08350 Grayhawk Way', 'NY', 'New York City', '11', 9, 'jhansard4@is.gd', 'cglas4@scientificamerican.com', '212-210-7513', '716-519-2235');
insert into treatment_center (center_id, street_address, state, city, zip_code, professional_id, email_1, email_2, phone_1, phone_2) values (6, '4425 South Plaza', 'GA', 'Atlanta', '8', 13, 'rcowle5@goodreads.com', 'ldickenson5@so-net.ne.jp', '404-522-1254', '215-256-6422');
insert into treatment_center (center_id, street_address, state, city, zip_code, professional_id, email_1, email_2, phone_1, phone_2) values (7, '44 Maple Circle', 'PA', 'Bethlehem', '8901', 10, 'fhinkens6@theguardian.com', 'gphillipps6@uiuc.edu', '610-397-3972', '206-875-8447');
insert into treatment_center (center_id, street_address, state, city, zip_code, professional_id, email_1, email_2, phone_1, phone_2) values (8, '1762 Oxford Center', 'CO', 'Denver', '63892', 8, 'mhurne7@discuz.net', 'bbaldazzi7@hud.gov', '303-748-8552', '727-318-6917');
insert into treatment_center (center_id, street_address, state, city, zip_code, professional_id, email_1, email_2, phone_1, phone_2) values (9, '790 Florence Point', 'CA', 'Orange', '4', 7, 'mhuffey8@hexun.com', 'mklossmann8@friendfeed.com', '760-170-4763', '312-364-9811');
insert into treatment_center (center_id, street_address, state, city, zip_code, professional_id, email_1, email_2, phone_1, phone_2) values (10, '8653 Katie Circle', 'TX', 'Austin', '93', 9, 'codevey9@over-blog.com', 'ashimon9@elegantthemes.com', '512-506-8312', '559-849-4933');
insert into treatment_center (center_id, street_address, state, city, zip_code, professional_id, email_1, email_2, phone_1, phone_2) values (11, '31803 Killdeer Court', 'AZ', 'Phoenix', '09', 5, 'hcamelia@pinterest.com', 'walesioa@multiply.com', '623-187-8557', '513-108-0537');
